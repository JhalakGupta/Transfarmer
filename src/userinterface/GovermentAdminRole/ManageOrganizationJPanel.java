...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo() {
        ...
        for (Type type : Organization.Type.values()) {
            if (type.getValue().equals(Type.Banking.getValue()) || type.getValue().equals(Type.MinistryOfEducation.getValue())) {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(149, 115, 480, 92));
        ...
        add(addJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 270, -1, -1));

        organizationJComboBox.setFont(new java.awt.Font("Chalkboard SE", 0, 12)); // NOI18N
        organizationJComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(298, 225, 180, -1));

        jLabel1.setFont(new java.awt.Font("Chalkboard SE", 0, 12)); // NOI18N
        jLabel1.setText("ORGANIZATION TYPE:");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(149, 229, -1, -1));
