...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo() {
        ...
        for (Type type : Organization.Type.values()) {
            if (type.getValue().equals(Type.Carrier.getValue())) {
    ...
    private void initComponents() {
        ...
        add(addJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 260, -1, -1));

        organizationJComboBox.setFont(new java.awt.Font("Chalkboard SE", 0, 12)); // NOI18N
        organizationJComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 210, 180, -1));

        jLabel1.setFont(new java.awt.Font("Chalkboard SE", 0, 12)); // NOI18N
        jLabel1.setText("ORGANIZATION TYPE:");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 210, -1, 30));
