...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo() {
        ...
        for (Type type : Organization.Type.values()) {
            if (type.getValue().equals(Type.Thirdparty.getValue())
    ...
    private void initComponents() {
        ...
        add(addJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 270, -1, -1));

        organizationJComboBox.setFont(new java.awt.Font("Chalkboard SE", 0, 12)); // NOI18N
        organizationJComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, 190, 20));
